...
def sample_results():
    return {
        ...
        "he4": {
            ...
            "if_wins": 4,
            "if_wins_on": ["auc_roc", "ap", "precision_at_5pct", "ef_at_5pct"],
            "he4_pass": True,
        },
    }
...
def sample_sensitivity():
    return {
        "proxy_sensitivity": {
            ...
            "delta_auc_tipo_a": 0.054,
            "delta_ap_tipo_a": 0.05,
            "delta_auc_wide": 0.01,
            "robust": False,
        },
        "per_type_metrics": {
        ...
        "feature18_sensitivity": {
            "auc_31_features": 0.63,
            "auc_30_features": 0.61,
            "delta_auc": 0.023,
            "low_sensitivity": False,
            "jaccard_top5pct": 0.85,
            "spearman_r": 0.97,
        },
        "ablation_31_vs_21": {
            "model_31": {
            ...
            "model_21": {
                ...
                "ap": 0.16,
                "precision_at_5pct": 0.22,
                "enrichment_factor": 2.1,
            },
            "delta": {
                "auc_roc": 0.01,
                "ap": 0.01,
                "precision_at_5pct": 0.01,
                "enrichment_factor": 0.1,
            },
        ...
        "segment_metrics": {
            ...
            "by_category": {
                "reservation": {
                    "auc_roc": 0.65,
                    "ap": 0.18,
                    "precision_at_5pct": 0.25,
                    "enrichment_factor": 2.5,
                    "n_transactions": 1500000,
                }
            },
        },
        "anomaly_typology": {
            "type_distribution": {
                "mixed": {"count": 99000, "pct": 79.0},
                "amount": {"count": 13000, "pct": 10.4},
                "velocity": {"count": 2600, "pct": 2.1},
                "discount": {"count": 1400, "pct": 1.1},
                "credit_flow": {"count": 6000, "pct": 4.8},
                "role_deviation": {"count": 1400, "pct": 1.1},
                "diversity": {"count": 100, "pct": 0.1},
                "reversal": {"count": 1200, "pct": 1.0},
                "temporal": {"count": 0, "pct": 0.0},
            }
        },
        "user_risk_profiles": {
            "n_users_total": 406000,
            "n_users_flagged": 15000,
            "pct_users_flagged": 3.7,
    ...
    return {
        "posthoc_analysis": {
            "facility_concentration": {
                "n_facilities_with_enrichment_gt_2": 118,
                "top_10_facilities": [
                    {
                        "facility_id": 1,
                        "n_transactions": 500,
                        "anomaly_rate": 0.25,
                        "anomaly_enrichment": 5.0,
                    },
                ],
            },
            "manager_concentration": {
                ...
                "top_10_managers": [],
                "aggregate_only": {
                    "n_transactions_with_manager_intervention": 1400000,
            ...
            "currency_concentration": {
                "currencies_affected": [
                    {
                        "currency": "USD",
                        "n_transactions": 1800000,
                        "anomaly_rate": 0.04,
                        "anomaly_enrichment": 0.8,
                    },
                    {
                        "currency": "HNL",
                        "n_transactions": 50000,
                        "anomaly_rate": 0.12,
                        "anomaly_enrichment": 2.4,
                    },
                ]
            },
        }
